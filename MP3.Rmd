...
```{r, fig.retina=NULL, out.width=1000, echo=FALSE}
knitr::include_graphics("https://media1.tenor.com/images/594d5dc0bf9340aaee6e1bfbccfbdc9e/tenor.gif")
```
![*Max Greenfield as Schmidt in "New Girl"*](https://media1.tenor.com/images/594d5dc0bf9340aaee6e1bfbccfbdc9e/tenor.gif) {width = 300px}
...
Moreover we need to keep in mind that the US is NOT the only target audience for Hollywood. North America contributes to only 1/3 of Hollywood’s total income (The Economist, 2011). The rest of world including many Asian and African countries also add to Hollywood’s revenue. The remakes might be boring and repetitive to the American audience, but they are fresh and new to the 2/3 of Hollywood’s income generators (The Economist, 2011)^[3]. Therefore, Hollywood might not stop cashing in on the success of the originals right away!
